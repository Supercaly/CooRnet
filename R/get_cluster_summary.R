...
#'         A data frame containing summary data by each coordinated cluster:
...
get_cluster_summary <- function(output, component_threshold=0.8, domains_limit=5, exclude_domains="google.com, facebook.com, youtube.com", domains_history=FALSE){
